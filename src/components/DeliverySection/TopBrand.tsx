...
const items = [
  { label: "la pinoz ", img: "/images/thali.png" },
  { label: "Burger King", img: "/images/vegmeal.png" },
  { label: "India backery", img: "/images/biryani.png" },
...
export default function TopBrand() {
  ...
  return (
    <div className="relative px-4 max-w-7xl mx-auto mt-4">
      <h2 className="text-2xl font-semibold my-8">Top Brand for You</h2>
